...
import com.moko.lw003.databinding.Lw003ActivityFilterBinding;
...
import com.moko.support.lw003.entity.DataTypeEnum;
...
public class FilterOptionsBActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private Lw003ActivityFilterBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw003ActivityFilterBinding.inflate(getLayoutInflater());
                                ...
                                switch (configKeyEnum) {
                                    case KEY_TRACKING_FILTER_SWITCH_B:
                                        if (length == 1) {
                                            ...
                                            mBind.ivCondition.setImageResource(filterSwitchEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                        }
                                        break;
                                    case KEY_TRACKING_FILTER_RSSI_B:
                                        if (length == 1) {
                                    ...
                                    case KEY_TRACKING_FILTER_MAC_B:
                                        if (length > 0) {
                                            ...
                                            mBind.ivMacAddress.setImageResource(filterMacEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                    ...
                                    case KEY_TRACKING_FILTER_ADV_NAME_B:
                                        if (length > 0) {
                                            ...
                                            mBind.ivAdvName.setImageResource(filterNameEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                    ...
                                    case KEY_TRACKING_FILTER_UUID_B:
                                        if (length > 0) {
                                            ...
                                            mBind.ivIbeaconUuid.setImageResource(filterUUIDEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                    ...
                                    case KEY_TRACKING_FILTER_MAJOR_RANGE_B:
                                        if (length > 0) {
                                            ...
                                            mBind.ivIbeaconMajor.setImageResource(filterMajorEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                    ...
                                    case KEY_TRACKING_FILTER_MINOR_RANGE_B:
                                        if (length > 0) {
                                            ...
                                            mBind.ivIbeaconMinor.setImageResource(filterMinorEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                    ...
                                    case KEY_TRACKING_FILTER_ADV_RAW_DATA_B:
                                        if (length > 0) {
                                            ...
                                            mBind.ivRawAdvData.setImageResource(filterRawAdvDataEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                            ...
                                            if (length > 1) {
                                                ...
                                                for (int i = 0, l = rawDataBytes.length; i < l; ) {
                                                    View v = LayoutInflater.from(FilterOptionsBActivity.this).inflate(R.layout.lw003_item_raw_data_filter, mBind.llRawDataFilter, false);
    ...
    public void onRawDataAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw003_item_raw_data_filter, mBind.llRawDataFilter, false);
        mBind.llRawDataFilter.addView(v);
    }
