...
public class FilterOptionsBActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw003_activity_filter);
                                ...
                                switch (configKeyEnum) {
                                    case KEY_TRACKING_FILTER_SWITCH_B:
                                        if (length == 1) {
                                            ...
                                            ivCondition.setImageResource(filterSwitchEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                        }
                                        break;
                                    case KEY_TRACKING_FILTER_RSSI_B:
                                        if (length == 1) {
                                    ...
                                    case KEY_TRACKING_FILTER_ADV_RAW_DATA_B:
                                        if (length > 0) {
                                            ...
                                            ivRawAdvData.setImageResource(filterRawAdvDataEnable ? R.drawable.lw003_ic_checked : R.drawable.lw003_ic_unchecked);
                                            ...
                                            if (length > 1) {
                                                ...
                                                for (int i = 0, l = rawDataBytes.length; i < l; ) {
                                                    View v = LayoutInflater.from(FilterOptionsBActivity.this).inflate(R.layout.lw003_item_raw_data_filter, llRawDataFilter, false);
    ...
    public void onRawDataAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw003_item_raw_data_filter, llRawDataFilter, false);
        llRawDataFilter.addView(v);
    }
