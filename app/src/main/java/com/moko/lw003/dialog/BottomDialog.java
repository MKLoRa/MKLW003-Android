...
import com.moko.lw003.databinding.Lw003DialogBottomBinding;

import java.util.ArrayList;

public class BottomDialog extends MokoBaseDialog<Lw003DialogBottomBinding> {
    ...
    @Override
    protected Lw003DialogBottomBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw003DialogBottomBinding.inflate(inflater, container, false);
    }
