...
import com.moko.lw003.databinding.Lw003DialogChangePasswordBinding;
import com.moko.lw003.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw003DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw003DialogChangePasswordBinding getViewBind() {
        return Lw003DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
