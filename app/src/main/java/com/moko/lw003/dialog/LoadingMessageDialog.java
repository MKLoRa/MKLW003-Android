...
import com.moko.lw003.databinding.Lw003DialogLoadingMessageBinding;
import com.moko.lw003.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends MokoBaseDialog<Lw003DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw003DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw003DialogLoadingMessageBinding.inflate(inflater, container, false);
    }

    @Override
    protected void onCreateView() {
        ProgressDrawable progressDrawable = new ProgressDrawable();
        progressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.lw003_text_black_4d4d4d));
...
//        }, DIALOG_DISMISS_DELAY_TIME);
    ...
    public int getDialogStyle() {
        return R.style.LW003CenterDialog;
    }
