...
import com.moko.lw003.databinding.Lw003DialogPasswordBinding;
import com.moko.lw003.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw003DialogPasswordBinding> {
    ...
    @Override
    protected Lw003DialogPasswordBinding getViewBind() {
        return Lw003DialogPasswordBinding.inflate(getLayoutInflater());
    }
