...
public class PermissionDialog extends RationaleDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View layoutView = inflater.inflate(R.layout.lw003_dialog_permission, container, false);
    ...
    private void initWindow() {
        if (null != getDialog()) {
            ...
            if (null != window) {
                ...
                window.setBackgroundDrawableResource(R.drawable.lw003_shape_radius_solid_ffffff);
            }
        }
    }
