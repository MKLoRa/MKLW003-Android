...
import com.moko.lw003.databinding.Lw003DialogScanFilterBinding;

public class ScanFilterDialog extends BaseDialog<Lw003DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw003DialogScanFilterBinding getViewBind() {
        return Lw003DialogScanFilterBinding.inflate(getLayoutInflater());
    }
